...
my_obj_rawhist_rayraw	:= $(core_obj) user_rawhist_rayraw.o $(gui_obj)
my_tgt_rawhist_rayraw	:= $(bin_dir)/raw_hist_rayraw
...
#______________________________________________________________________________
my_obj_rawhist_rayraw	:= $(addprefix $(my_dir)/src/,$(my_obj_rawhist_rayraw))
my_obj_rawhist_rayraw	:= $(my_obj_rawhist_rayraw) \
		$(my_dir)/dict/GuiPs_Dict.o
my_lib_rawhist_rayraw	:= libmyrawhist_rayraw.so
$(eval $(call make-lib,$(my_lib_rawhist_rayraw),$(my_obj_rawhist_rayraw)))
$(eval $(call make-gui-target,$(my_tgt_rawhist_rayraw),$(my_lib_rawhist_rayraw)))
