...
public:
  ...
  bool GetDeHighGain( int cid, int plid, int seg, int ud, int adc, double &de ) const;
  bool GetDeLowGain( int cid, int plid, int seg, int ud, int adc, double &de ) const;
  ...
  double GetP0( int cid, int plid, int seg, int ud, int at=0) const;
  double GetP1( int cid, int plid, int seg, int ud, int at=0) const;
  ...
  { return GetDeHighGain( cid, plid, seg, ud, adc, de ); }

private:
  HodoTParam *GetTmap( int cid, int plid, int seg, int ud ) const;
  HodoAParam *GetAHmap( int cid, int plid, int seg, int ud ) const;
  HodoAParam *GetALmap( int cid, int plid, int seg, int ud ) const;
  HodoFParam *GetFmap( int cid, int plid, int seg, int ud ) const;
  void ClearAHCont( void );
  void ClearALCont( void );
