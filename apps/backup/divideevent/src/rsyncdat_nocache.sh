#!/bin/bash
# rsyncdat_nocache.sh  (nocache/帯域/Dirty監視入り)
# 使い方:
#   ./rsyncdat_nocache.sh <datファイル名 or 絶対パス> [interval_seconds]
# 例:
#   ./rsyncdat_nocache.sh run00044.dat
#   BW_LIMIT=30M ./rsyncdatnew.sh /root/daq/data/run00044.dat 10
#
# 改善点:
